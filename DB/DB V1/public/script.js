window.onload = function () {
  ...
  var spawnRate = spawnRange.value;
  ...
  function changeBarColor() {
    ...
    barDivBorder.style.borderBottom = "2px solid " + barInput.value + ";";
  }
  ...
  function spawnParticles() {
    particleInterval = setInterval(function () {
      ...
      //console.log(particleWidth);
      //randWidth = randWidth + particleWidth.trim();
      //console.log("WIDTH: " + randWidth);
